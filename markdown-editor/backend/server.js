...
app.post('/api/save-markdown', async (req, res) => {
    try {
        ...
        // 使用原始 GitHub API 调用（测试成功的方案）
        const githubApiUrl = `https://api.github.com/repos/${process.env.GITHUB_OWNER}/${process.env.GITHUB_REPO}/contents/${filePath}`;
        ...
        console.log('调用GitHub API:', githubApiUrl);
